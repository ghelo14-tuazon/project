...
<body>
    <div class="container mt-5">
        ...
        <div class="row">
            <div class="col-md-12">
                <a href="<?= base_url('student/' . $user['id']) ?>" class="btn btn-primary mb-3">Back</a>
            </div>
        </div>
        <div class="row">
            <div class="col-md-6 offset-md-3">
                <form action="/update/save" method="post" enctype="multipart/form-data">
                    ...
                    <!-- Add a hidden field to store the existing image name -->
                    <input type="hidden" name="existing_image" value="<?= $user['image_name'] ?>">
